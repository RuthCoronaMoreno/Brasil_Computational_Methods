...
## NAs and zeroes --------------------------------------------------------------
apply(iris, 2, function(x) sum(is.na(x))) #function(x) sum(is.na(x)) <- define la función de sumar los NA

## Descriptive statistics ------------------------------------------------------
vars <- iris[, -5]

### Measures of central tendency
apply(vars, 2, mean) #2: columna
...
boxplot(iris$Sepal.Width)
my_boxplot <- boxplot(iris$Sepal.Width, plot = FALSE) #You can find values of outliers
my_boxplot
